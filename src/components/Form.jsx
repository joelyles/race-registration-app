  ...
  return (
    ...
    {success ? (
       <div className="h-full flex px-4 bg-slate-200 ">
        <div className="flex flex-col mx-auto mt-8 mb-8 p-4 rounded-md shadow-md bg-white h-1/2 w-5/6 sm:w-3/4">
          <h4 className="flex font-semibold tracking-wider justify-center text-2xl ">Registration Complete</h4>
          <div className="flex flex-col items-center p-4 bg-blue-200 mt-6 rounded-md shadow-md h-1/2">
